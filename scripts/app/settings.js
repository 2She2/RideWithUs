...
var appSettings = {
    ...
    everlive: {
        apiKey: 'SuvbMwIYbZz8swnU', // Put your Backend Services API key here
        scheme: 'http'
    },
    ...
    messages: {
        ...
        removeOfferConfirm: 'Are you sure you want to delete this Offer?',
        joinOfferConfirm: 'Are you sure you want to join this Offer?'
    }
};